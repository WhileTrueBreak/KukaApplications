...
public class DirectHandoverFinlay extends RoboticsAPIApplication {
	...
	public void perform_handover(int part, int grip_offset, int part_in_jig){
		// part: integer 1-4
		// grip_offset: how wide the gripper should be picking up parts - important for certain parts, 0 is open
		// part_in_jig: if the part is in the jig or not (to decide whether to do robot to human or human to robot handover method
