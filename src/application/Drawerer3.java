...
public class Drawerer3 extends RoboticsAPIApplication{
	@Inject
...
//		ThreadUtil.milliSleep(10000);
	...
	private void penUp(){
		gripper.move(linRel(0,0, -Drawerer3.PEN_UP_DIST).setJointVelocityRel(0.2));
	}
	
	private void penDown(){
		gripper.move(linRel(0, 0, Drawerer3.PEN_DOWN_DIST+Drawerer3.PEN_UP_DIST).setMode(springRobot).setCartVelocity(20));
	}
	...
	private void drawPathPlan(PathPlan plan, Frame originFrame, Canvas canvas) {
		...
		Vector3D v = Vector3D.of(-Drawerer3.PEN_UP_DIST,0,0);
	...
	public void run() throws Exception {
		...
		gripper.move(linRel(0,0, -Drawerer3.PEN_UP_DIST*2).setJointVelocityRel(0.2));
