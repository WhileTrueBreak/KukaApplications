...
//	    robot.move(ptp(getApplicationData().getFrame("/DrivePos")).setJointVelocityRel(0.3));
		...
		SplineJP avoidPole_place = new SplineJP(ptp(getApplicationData().getFrame("/Place_Job/spline_place")),ptp(getApplicationData().getFrame("/Pick_Job/Up"))).setJointVelocityRel(0.3);
