...
public class OPCUA_Client_Control1 {
	...
	public void SetUp() throws Exception {
		...
		target = findNode("robot1", references);
		nodeId = target;
		...
		NID_Connected = findNode("R1c_Connected",references);
		NID_Start = findNode("R1c_Start",references);
		NID_ProgID = findNode("R1c_ProgID",references);
		NID_Count = findNode("LabCount",referencesC);
		NID_End = findNode("R1f_End",references);
		NID_Ready = findNode("R1f_Ready",references);
		
		NID_int1 = findNode("R1c_int1",references);
		NID_int2 = findNode("R1c_int2",references);
		NID_int3 = findNode("R1c_int3",references);
		...
		NID_Joi1 = findNode("R1c_Joi1", references);
		NID_Joi2 = findNode("R1c_Joi2", references);
		NID_Joi3 = findNode("R1c_Joi3", references);
		NID_Joi4 = findNode("R1c_Joi4", references);
		NID_Joi5 = findNode("R1c_Joi5", references);
		NID_Joi6 = findNode("R1c_Joi6", references);
		NID_Joi7 = findNode("R1c_Joi7", references);
		NID_Vel = findNode("R1c_Vel", references);

		NID_PosX = findNode("R1c_PosX", references);
		NID_PosY = findNode("R1c_PosY", references);
		NID_PosZ = findNode("R1c_PosZ", references);
		NID_RotA = findNode("R1c_RotA", references);
		NID_RotB = findNode("R1c_RotB", references);
		NID_RotC = findNode("R1c_RotC", references);
		
		NID_GripperControl = findNode("R1c_GripperControl", references);
		NID_GripperAct = findNode("R1c_GripperAct", references);
		NID_GripperSpeed = findNode("R1c_GripperSpeed", references);
		NID_GripperForce = findNode("R1c_GripperForce", references);
		NID_GripperPos = findNode("R1c_GripperPos", references);
	...
	protected static void initialize(UaClient client) throws SecureIdentityException, IOException, UnknownHostException {
		...
		appDescription.setApplicationUri("Robot2_Control");
		appDescription.setProductUri("Robot2_Control");
