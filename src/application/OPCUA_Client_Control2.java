...
public class OPCUA_Client_Control2 {
	...
	public void ServerUpdate() throws Exception {
		...
		Ready = client.readAttribute(NID_Ready,attributeId).getValue().booleanValue();
	...
	public void setGripperForce(int A) throws Exception {
		client.writeAttribute(NID_GripperForce, attributeId,  A);
	}
	
	// set int1,2,3
	public void setint1(int A) throws Exception {
		client.writeAttribute(NID_int1, attributeId,  A);
	}
	public void setint2(int A) throws Exception {
		client.writeAttribute(NID_int2, attributeId,  A);
	}
	public void setint3(int A) throws Exception {
		client.writeAttribute(NID_int3, attributeId,  A);
	}
	...
	public void setGripperAct(boolean A) throws Exception {
		client.writeAttribute(NID_GripperAct, attributeId, A);
	}
