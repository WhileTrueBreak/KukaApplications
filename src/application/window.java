...
//		
		...
		robot.move(linRel(0, 0, 50).setJointVelocityRel(0.3).breakWhen(force));
		robot.move(linRel(0, 0, -5).setJointVelocityRel(0.3).breakWhen(force));
		Vector3D openLine = openvector.multiply(150);
		logger.info("moving on a line");
