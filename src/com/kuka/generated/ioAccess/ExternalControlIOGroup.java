...
public class ExternalControlIOGroup extends AbstractIOGroup
{
	...
	public ExternalControlIOGroup(Controller controller)
	{
		...
		addInput("External_Estop_ACK", IOTypes.BOOLEAN, 1);
	}
	...
	/**
	 * Gets the value of the <b>digital input '<i>External_Estop_ACK</i>'</b>.<br>
	 * <i>This method is automatically generated. Please, do not modify!</i>
	 * <p>
	 * <b>I/O direction and type:</b><br>
	 * digital input
	 ...
	 * [false; true]
	 *
	 * @return current value of the digital input 'External_Estop_ACK'
	 */
	public boolean getExternal_Estop_ACK()
	{
		return getBooleanIOValue("External_Estop_ACK", false);
	}
