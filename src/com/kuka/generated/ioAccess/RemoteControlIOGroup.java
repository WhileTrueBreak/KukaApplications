...
public class RemoteControlIOGroup extends AbstractIOGroup
{
	...
	* 
	 * @deprecated The output 'Enable' has not been assigned to a field bus address - thus this operation will be <b>simulated</b> only.
	 */
	@Deprecated
	...
	/**
	 * Sets the value of the <b>mocked digital input '<i>Enable</i>'</b>.<br>
	 * <i>This method is automatically generated. Please, do not modify!</i>
	 * <p>
	 * <b>I/O direction and type:</b><br>
	 * digital input
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the mocked digital input 'Enable'
	* 
	 * @deprecated The output 'Enable' has not been assigned to a field bus address - thus this operation will be <b>simulated</b> only.
	 */
	@Deprecated
	public void setMockedEnableValue(java.lang.Boolean value)
	{
		setMockedInput("Enable", value);
	}
